...
ResNet-101 for image classification into 1000 classes:
   ...
   with slim.arg_scope(resnet_v1.resnet_arg_scope()):
      model, end_points = resnet_v1.resnet_v1_101(inputs, 1000, is_training=False)
ResNet-101 for semantic segmentation into 21 classes:
   # inputs has shape [batch, 513, 513, 3]
   with slim.arg_scope(resnet_v1.resnet_arg_scope()):
      model, end_points = resnet_v1.resnet_v1_101(inputs,
                                                21,
                                                is_training=False,
                                                global_pool=False,
                                                output_stride=16)
...
def resnet_v1(inputs,
  ...
  Returns:
    model: A rank-4 tensor of size [batch, height_out, width_out, channels_out].
      ...
      average pooling. If num_classes a non-zero integer, model contains the
